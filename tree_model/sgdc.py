...
def train():
    ...
    bst = SGDClassifier_FNC.fit(data_x, data_y)
    joblib.dump(bst, 'sgdc_cluster_train_squared_svm.pkl')
...
if __name__ == '__main__':
    #build_test_data()
    #cv()
    SGDClassifier_FNC = SGDClassifier(loss='squared_hinge', random_state= 0)
    train()
